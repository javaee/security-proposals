 ...
 * Users, Groups and standard Roles are unique within a Realm.
 */
@IdentityPartition(supportedTypes = {IdentityType.class})
public class Realm extends AbstractPartition {

    private static final long serialVersionUID = -1150676763019632211L;

    /**
     * The name of the default realm, used when no realm is specified.
     */
